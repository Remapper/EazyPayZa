Contributing to EazyPayZA Core
==================================

The EazyPayZA Core project operates an open contributor model where anyone is
...
The following applies to code changes to the EazyPayZA Core project, and is not to be
confused with overall EazyPayZA Network Protocol consensus changes.

Whether a pull request is merged into EazyPayZA Core rests with the project merge
...
Patches that change EazyPayZA consensus rules are considerably more involved than
...
Where a patch set proposes to change the EazyPayZA consensus, it must have been
...
The project leader is the release manager for each EazyPayZA Core release.
