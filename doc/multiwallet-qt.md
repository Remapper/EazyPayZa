...
In order to support loading of multiple wallets in eazypayza-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is eazypayza.cpp.
...
Changes to eazypayza.cpp
----------------------
eazypayza.cpp is the entry point into eazypayza-qt, and as such, will require some minor modifications to provide hooks for
