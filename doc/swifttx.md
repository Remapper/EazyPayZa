...
This mechanism has been integrated into Bitcore-Node-EazyPayZA which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/eazypayza/insight-api-eazypayza#web-socket-api](https://github.com/eazypayza/insight-api-eazypayza#web-socket-api)
* API: [https://github.com/eazypayza/insight-api-eazypayza#swifttx-transactions](https://github.com/eazypayza/insight-api-eazypayza#swifttx-transactions)
