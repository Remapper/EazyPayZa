...
#   c) node1 mines 32 blocks, so now node 0 has 500000EZPAY, node 1 has 4250EZPAY, node2 has none.
#   d) node0 sends 601 EZPAY to node2, in two transactions (301 EZPAY, then 300 EZPAY).
