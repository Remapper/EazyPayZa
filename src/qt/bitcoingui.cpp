...
// Copyright (c) 2017-2018 The EazyPayZA Coin developers
                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    GUIUtil::restoreWindowGeometry("nWindow", QSize(950, 650), this);
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a EZPAY address"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for EazyPayZA Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your EZPAY addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified EZPAY addresses"));
    ...
    openInfoAction = new QAction(QIcon(":/icons/transaction_conflicted"), tr("&Information"), this);
    ...
    showHelpMessageAction->setStatusTip(tr("Show the EazyPayZA Coin help message to get a list with possible EazyPayZA Coin command-line options"));
...
void BitcoinGUI::createToolBars()
{
    if (walletFrame) {
        ...
        labelLogo->setPixmap(QIcon(":/images/eazypayza_logo_horizontal").pixmap(210, 50));
    ...
    if (enableWallet) {
       ...
       if (curStyle == "QWindowsStyle" || curStyle == "QWindowsXPStyle") {
        ...
        frameToolbar->setStyleSheet(".QFrame { margin-left:-0px; border-image: url(':/images/splash_testnet') 0 0 0 0 stretch stretch; }");;
...
void BitcoinGUI::message(const QString& title, const QString& message, unsigned int style, bool* ret)
{
    ...
    // Append title to "EazyPayZA Coin - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
