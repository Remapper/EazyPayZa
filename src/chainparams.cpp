...
// Copyright (c) 2017 The EazyPayZA developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x000003c299378cc60a2a0ebb5024ae7e89dfcf85492c00003423b1789fd5dc18"));
	

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1569760049, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nTargetSpacing = 1 * 60;  // EazyPayZA: 1 minute blocks during POW (block 1-200)
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1569760049;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 24843095;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000003c299378cc60a2a0ebb5024ae7e89dfcf85492c00003423b1789fd5dc18"));
        assert(genesis.hashMerkleRoot == uint256("0x801e9853f13522985a75dc56ac338971cd304c19659008c850069a4baed74714"));

        // EazyPayZA addresses start with 'E'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 33);
        // EazyPayZA script addresses start with '3'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 6);
        // EazyPayZA private keys start with 'K'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 46);
        // EazyPayZA BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // EazyPayZA BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // EazyPayZA BIP44 coin type is '222' (0x800000de)
...
public:
    CTestNetParams()
    {
        ...
        nTargetSpacing = 2 * 60;  // EazyPayZA: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
       ...
       // assert(hashGenesisBlock == uint256("0x000008467c3a9c587533dea06ad9380cded3ed32f9742a6c0c1aebc21bf2bc9b"));
        ...
        // Testnet EazyPayZA addresses start with 'g'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 98);
        // Testnet EazyPayZA script addresses start with '5' or '6'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 12);
        // Testnet private keys start with 'k'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 108);
        // Testnet EazyPayZA BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet EazyPayZA BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
...
public:
    CRegTestParams()
    {
        ...
        nTargetSpacing = 2 * 60;        // EazyPayZA: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        genesis.nTime = 1516926684;
