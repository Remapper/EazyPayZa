...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/eazypayza-cli.cpp \
           src/eazypayza-tx.cpp \
           src/eazypayza.cpp \
           src/db.cpp \
           ...
           src/qt/eazypayza.cpp \
           src/qt/eazypayzastrings.cpp \
...
RESOURCES += src/qt/eazypayza.qrc src/qt/eazypayza_locale.qrc

TRANSLATIONS += src/qt/locale/eazypayza_bg.ts \
                src/qt/locale/eazypayza_de.ts \
                src/qt/locale/eazypayza_en.ts \
                src/qt/locale/eazypayza_es.ts \
                src/qt/locale/eazypayza_fi.ts \
                src/qt/locale/eazypayza_fr.ts \
                src/qt/locale/eazypayza_it.ts \
                src/qt/locale/eazypayza_ja.ts \
                src/qt/locale/eazypayza_pl.ts \
                src/qt/locale/eazypayza_pt.ts \
                src/qt/locale/eazypayza_ru.ts \
                src/qt/locale/eazypayza_sk.ts \
                src/qt/locale/eazypayza_sv.ts \
                src/qt/locale/eazypayza_vi.ts \
                src/qt/locale/eazypayza_zh_CN.ts \
                src/qt/locale/eazypayza_zh_TW.ts
